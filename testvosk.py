...
# cap = cv2.VideoCapture("http://192.168.254.37:8080/video")
                    ...
                    "messages": [
                        {
                            ...
                            "content": [
                                {
                                    "type": "text",
                                    "text": f"{text} (new line) if the person asked you to help them see or help them understand what they are looking at (you are their eyes), then give a vivid description and perhaps using ocr, read out the text you see. keep this response between 10-20 words."
                                },
                                {
                                    "type": "image_url",
                                    "image_url": {
